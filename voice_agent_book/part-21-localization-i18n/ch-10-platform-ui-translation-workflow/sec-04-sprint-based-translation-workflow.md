# Sprint-Based Translation Workflow

## Overview

This section covers Sprint-Based Translation Workflow in depth. The capability is part of the 10 Platform Ui Translation Workflow chapter and provides critical functionality for the voice agent platform's production operations.
...
kind: Deployment
metadata:
  name: sprint-based-translation-workflow
spec:
  replicas: 3
  strategy:
    type: RollingUpdate
  ...
  template:
    spec:
      containers:
        - name: service
          image: voiceagent/sprint-based-translation-workflow:latest
          ports:
            - containerPort: 3000
          env:
            - name: NODE_ENV
...
Sprint-Based Translation Workflow is designed for production reliability from day one. The patterns and practices described here ensure the capability meets the high standards required for enterprise voice AI deployments.
