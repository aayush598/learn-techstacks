# Translation Export & Deployment

## Overview

This section covers Translation Export & Deployment in depth. The capability is part of the 10 Platform Ui Translation Workflow chapter and provides critical functionality for the voice agent platform's production operations.
...
kind: Deployment
metadata:
  name: translation-export-&-deployment
spec:
  replicas: 3
  strategy:
    type: RollingUpdate
  ...
  template:
    spec:
      containers:
        - name: service
          image: voiceagent/translation-export-&-deployment:latest
          ports:
            - containerPort: 3000
          env:
            - name: NODE_ENV
...
Translation Export & Deployment is designed for production reliability from day one. The patterns and practices described here ensure the capability meets the high standards required for enterprise voice AI deployments.
