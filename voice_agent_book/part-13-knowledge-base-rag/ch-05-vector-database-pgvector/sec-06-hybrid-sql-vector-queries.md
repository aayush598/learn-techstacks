# Section: Hybrid SQL + Vector Queries

Hybrid SQL + Vector Queries is a core component of the pgvector vector database. This section examines its architecture, implementation, and operational considerations.
